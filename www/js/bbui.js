		...
		if (titleBar.actionButton || titleBar.backButton) {
			titleBar.evenButtonWidths = function() {
									...
									if (this.actionButton && this.backButton) {
										...
										this.caption.style['margin-left'] = '10px';//(commonWidth + 24) +'px';
										this.caption.style['margin-right'] = '10px';(commonWidth + 24) +'px';
									} else if (this.actionButton) {
										this.caption.style['margin-left'] = '0px';
										this.caption.style['margin-left']  = '10px';//= (actionWidth + 24) +'px';
										this.caption.style['margin-right']  = '10px';//= (actionWidth + 24) +'px';
									} else if (this.backButton) {
										this.caption.style['margin-right'] = '0px';
										this.caption.style['margin-left']  = '10px';//= (backWidth + 24) +'px';
										this.caption.style['margin-right']  = '10px';//= (backWidth + 24) +'px';
									}
								};
